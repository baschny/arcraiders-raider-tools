...
import { BriefcaseBusiness, Hammer, Home, Info, List, Package, Target } from 'lucide-react';
import { useLocale } from '../../../shared/context/LocaleContext';

export type ViewId = 'welcome' | 'stash' | 'lists' | 'hideout' | 'projects' | 'in-raid' | 'crafting';
